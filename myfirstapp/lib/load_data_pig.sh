data = load '/user/skamalj/oozie_test/resultdf_parquet_gzip' using parquet.pig.ParquetLoader AS (order_date: chararray, order_status: chararray, total_orders: int, order_amount: float);
